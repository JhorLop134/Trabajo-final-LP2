    ...
    <div class="container pb-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="text-muted d-flex align-items-center">
                                <span class="live-dot"></span> Actualizado: {fecha_actual}
                            </small>
                        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <div class="card p-4 h-100">
                    <h5 class="fw-bold mb-4 text-secondary">
                        <i class="fas fa-list-ul me-2"></i> Historial de Productos
                    </h5>
            ...
            <div class="col-lg-5">
                <div class="card p-4 h-100">
                    <h5 class="fw-bold mb-4 text-secondary">
                        <i class="fas fa-chart-pie me-2"></i> Análisis Visual de Costos
                    </h5>
                    <img src="grafico_precios.png" class="img-fluid rounded border border-light" alt="Gráfico">
